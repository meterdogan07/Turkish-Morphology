...
task_no = 0
tasks = ["Transformer"]
logger_file   = 'exp_split_2'      # Add ExpNUMBER !!!         
...
args.embed_dim = 512
args.src_hid_size = 512
args.src_nb_layers = 4
args.trg_hid_size = 512
...
#--------------------------------------------------------------------------------------------------
# Data Loader
trmor         = Parser(sentence_start="<S", sentence_end="</S", part_seperator="\t", tag_seperator="+", unk_token="<unk>")
...
logger.info(f"src_vocab: {surf_vocab}")
logger.info(f"trg_vocab: {feature_vocab}")
#--------------------------------------------------------------------------------------------------
